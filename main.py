...
class Window(Screen):
    def __init__(self, **kwargs):
        ...
        pb1 = Button(text = "start")
        pb2 = Button(text = "stop")
        pb3 = Button(text = "reset")
        pb4 = Button(text = "start")
        pb5 = Button(text = "stop")
        pb6 = Button(text = "reset")
        l3 = Label(text = "Enter seconds:", size_hint = (0.5, 0.6))
        timerinput = TextInput(multiline = False, size_hint = (1, 0.6))
        lv1 = BoxLayout(orientation = "vertical")
        lh1 = BoxLayout(orientation = "horizontal")
        lh2 = BoxLayout(orientation = "horizontal")
        lh3 = BoxLayout(orientation = "vertical")
        lh4 = BoxLayout(orientation = "horizontal")
        lh5 = BoxLayout(orientation = "horizontal")
        lh1.add_widget(pb1)
        lh1.add_widget(pb2)
        lh1.add_widget(pb3)
        lh2.add_widget(pb4)
